...
namespace IdentityServer4.RavenDB.IntegrationTests.Extensions
{
    public class IdentityServerBuilderExtensionTests : IntegrationTestBase
    {
            ...
            AddRavenDbConfigurationStoreCache_IsConfiguredCorrectly_When_AddRavenDbConfigurationStore_IsCalledFirst()
        {
            ...
            Assert.Contains(services,
                descriptor => descriptor.ImplementationType == typeof(CachingResourceStore<ResourceStore>));
            Assert.Contains(services,
                descriptor => descriptor.ImplementationType ==
                              typeof(CachingClientStore<ValidatingClientStore<ClientStore>>));
            Assert.Contains(services,
                descriptor => descriptor.ImplementationType == typeof(CachingCorsPolicyService<CorsPolicyService>));
        }
    }
}